    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
            <div className="text-center">
                <p className="text-lg font-medium text-gray-600 font-pj">2,157 people have said how good E-Lit</p>
                        ...
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“The Electric lighter is sleek and reliable—never fails to ignite and always looks great in my hand! It’s become a favorite accessory for any occasion.”</p>
                                </blockquote>
                            </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“I love the durability and consistent flame of my Electric lighter. It’s stylish and has become my go-to choice. The easy operation is a huge plus!.”</p>
                                </blockquote>
                            </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“Great value for the price! This lighter combines a modern design with dependable performance. Highly recommend! It’s been a fantastic addition to my collection.”</p>
                                </blockquote>
                            </div>
